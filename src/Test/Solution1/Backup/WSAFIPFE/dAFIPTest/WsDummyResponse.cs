namespace WSAFIPFE.dAFIPTest
{
    ...
    [Serializable, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlType(Namespace="ar.gov.afip.dia.serviciosWeb.wDigDepFiel"), DesignerCategory("code"), DebuggerStepThrough]
