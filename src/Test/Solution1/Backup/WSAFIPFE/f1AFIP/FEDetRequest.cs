namespace WSAFIPFE.f1AFIP
{
    ...
    [Serializable, DesignerCategory("code"), XmlType(Namespace="http://ar.gov.afip.dif.FEV1/"), DebuggerStepThrough, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlInclude(typeof(FECompConsResponse)), XmlInclude(typeof(FECAEDetRequest)), XmlInclude(typeof(FECAEADetRequest))]
