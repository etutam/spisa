namespace WSAFIPFE.bAFIPTest
{
    ...
    [Serializable, GeneratedCode("System.Xml", "2.0.50727.3053"), DebuggerStepThrough, XmlType(Namespace="http://ar.gov.afip.dif.bfe/"), DesignerCategory("code")]
    public class ClsBFEOutAuthorize
    {
