namespace WSAFIPFE.xAFIPTest
{
    ...
    [Serializable, DebuggerStepThrough, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlType(Namespace="http://ar.gov.afip.dif.fex/"), DesignerCategory("code")]
    public class FEXResponse_DST_pais
    {
