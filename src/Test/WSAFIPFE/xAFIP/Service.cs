namespace WSAFIPFE.xAFIP
{
    ...
    [WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.fex/"), GeneratedCode("System.Web.Services", "2.0.50727.3053"), DesignerCategory("code"), DebuggerStepThrough]
