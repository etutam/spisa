namespace WSAFIPFE.wsaaTest
{
    ...
    [GeneratedCode("System.Web.Services", "2.0.50727.3053"), WebServiceBinding(Name="LoginCmsSoapBinding", Namespace="https://wsaa.afip.gov.ar/ws/services/LoginCms"), DesignerCategory("code")]
