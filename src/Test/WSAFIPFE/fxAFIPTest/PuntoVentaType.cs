namespace WSAFIPFE.fxAFIPTest
{
    ...
    [Serializable, GeneratedCode("System.Xml", "2.0.50727.3053"), DesignerCategory("code"), DebuggerStepThrough, XmlType(Namespace="http://impl.service.wsmtxca.afip.gov.ar/service/")]
