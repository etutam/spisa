namespace WSAFIPFE.sAFIP
{
    ...
    [WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.seg/"), DesignerCategory("code"), DebuggerStepThrough, GeneratedCode("System.Web.Services", "2.0.50727.3053")]
    public class Service : SoapHttpClientProtocol
    {
        ...
        public Service()
        {
            this.Url = MySettings.Default.WSAFIPFE_sAFIP_Service;
