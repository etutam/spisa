namespace WSAFIPFE.f1AFIP
{
    ...
    [DesignerCategory("code"), XmlInclude(typeof(FECabRequest)), XmlInclude(typeof(FEDetRequest)), XmlInclude(typeof(FECabResponse)), XmlInclude(typeof(FEDetResponse)), WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.FEV1/"), DebuggerStepThrough, GeneratedCode("System.Web.Services", "2.0.50727.3053")]
