namespace WSAFIPFE.f1AFIPTest
{
    ...
    [Serializable, DebuggerStepThrough, XmlType(Namespace="http://ar.gov.afip.dif.FEV1/"), DesignerCategory("code"), XmlInclude(typeof(FECAEDetRequest)), GeneratedCode("System.Xml", "2.0.50727.3053"), XmlInclude(typeof(FECompConsResponse)), XmlInclude(typeof(FECAEADetRequest))]
