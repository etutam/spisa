namespace WSAFIPFE.f1AFIPTest
{
    ...
    [GeneratedCode("System.Web.Services", "2.0.50727.3053"), XmlInclude(typeof(FECabRequest)), XmlInclude(typeof(FEDetRequest)), XmlInclude(typeof(FECabResponse)), XmlInclude(typeof(FEDetResponse)), WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.FEV1/"), DesignerCategory("code"), DebuggerStepThrough]
    public class Service : SoapHttpClientProtocol
    {
        ...
        public Service()
        {
            this.Url = MySettings.Default.WSAFIPFE_f1AFIPTest_Service;
