namespace WSAFIPFE.fxAFIPTest
{
    ...
    public class ComprobanteType
    {
        ...
        [XmlArray(Form=XmlSchemaForm.Unqualified), XmlArrayItem("otroTributo", Form=XmlSchemaForm.Unqualified, IsNullable=false)]
        ...
        [XmlArray(Form=XmlSchemaForm.Unqualified), XmlArrayItem("subtotalIVA", Form=XmlSchemaForm.Unqualified, IsNullable=false)]
