namespace WSAFIPFE.f1AFIP
{
    ...
    [Serializable, XmlType(Namespace="http://ar.gov.afip.dif.FEV1/"), XmlInclude(typeof(FECAEACabResponse)), DesignerCategory("code"), DebuggerStepThrough, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlInclude(typeof(FECAECabResponse))]
