namespace WSAFIPFE.f1AFIPTest
{
    ...
    [Serializable, DesignerCategory("code"), XmlType(Namespace="http://ar.gov.afip.dif.FEV1/"), DebuggerStepThrough, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlInclude(typeof(FECAEDetResponse)), XmlInclude(typeof(FECAEADetResponse))]
