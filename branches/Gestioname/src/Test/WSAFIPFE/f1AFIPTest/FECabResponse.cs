namespace WSAFIPFE.f1AFIPTest
{
    ...
    [Serializable, GeneratedCode("System.Xml", "2.0.50727.3053"), DesignerCategory("code"), DebuggerStepThrough, XmlType(Namespace="http://ar.gov.afip.dif.FEV1/"), XmlInclude(typeof(FECAECabResponse)), XmlInclude(typeof(FECAEACabResponse))]
