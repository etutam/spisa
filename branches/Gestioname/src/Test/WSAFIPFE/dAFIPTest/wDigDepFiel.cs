namespace WSAFIPFE.dAFIPTest
{
    ...
    [GeneratedCode("System.Web.Services", "2.0.50727.3053"), WebServiceBinding(Name="wDigDepFielSoap", Namespace="ar.gov.afip.dia.serviciosWeb.wDigDepFiel"), DesignerCategory("code"), DebuggerStepThrough]
