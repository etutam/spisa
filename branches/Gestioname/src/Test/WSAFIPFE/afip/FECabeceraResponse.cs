namespace WSAFIPFE.afip
{
    ...
    [Serializable, DesignerCategory("code"), XmlType(Namespace="http://ar.gov.afip.dif.facturaelectronica/"), GeneratedCode("System.Xml", "2.0.50727.3053"), DebuggerStepThrough]
