namespace WSAFIPFE.bAFIP
{
    ...
    [Serializable, GeneratedCode("System.Xml", "2.0.50727.3053"), XmlType(Namespace="http://ar.gov.afip.dif.bfe/"), DebuggerStepThrough, DesignerCategory("code")]
    public class ClsBFEResponse_Tipo_Cbte
    {
