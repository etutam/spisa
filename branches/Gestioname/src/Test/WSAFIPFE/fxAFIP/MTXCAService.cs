namespace WSAFIPFE.fxAFIP
{
    ...
    [WebServiceBinding(Name="MTXCAServiceSoap11Binding", Namespace="http://impl.service.wsmtxca.afip.gov.ar/service/"), GeneratedCode("System.Web.Services", "2.0.50727.3053"), DesignerCategory("code"), DebuggerStepThrough]
    public class MTXCAService : SoapHttpClientProtocol
    {
        ...
        public MTXCAService()
        {
            this.Url = MySettings.Default.WSAFIPFE_fxAFIP_MTXCAService;
        ...
        [return: XmlArray("arrayCAEAResponse", Form=XmlSchemaForm.Unqualified), XmlArrayItem("CAEAResponse", Form=XmlSchemaForm.Unqualified, IsNullable=false)]
        ...
        [return: XmlArrayItem("codigoDescripcion", Form=XmlSchemaForm.Unqualified, IsNullable=false), XmlArray("arrayTiposDocumento", Form=XmlSchemaForm.Unqualified)]
        ...
        [return: XmlArrayItem("codigoDescripcion", Form=XmlSchemaForm.Unqualified, IsNullable=false), XmlArray("arrayTiposTributo", Form=XmlSchemaForm.Unqualified)]
        ...
        public ResultadoSimpleType informarComprobanteCAEA([XmlElement(Form=XmlSchemaForm.Unqualified)] AuthRequestType authRequest, [XmlElement(Form=XmlSchemaForm.Unqualified)] ComprobanteType comprobanteCAEARequest, [XmlElement(Form=XmlSchemaForm.Unqualified, DataType="date")] ref DateTime fechaProceso, [XmlElement(Form=XmlSchemaForm.Unqualified)] ref ComprobanteCAEAResponseType comprobanteCAEAResponse, [XmlArrayItem("codigoDescripcion", Form=XmlSchemaForm.Unqualified, IsNullable=false), XmlArray(Form=XmlSchemaForm.Unqualified)] ref CodigoDescripcionType[] arrayObservaciones, [XmlArrayItem("codigoDescripcion", Form=XmlSchemaForm.Unqualified, IsNullable=false), XmlArray(Form=XmlSchemaForm.Unqualified)] ref CodigoDescripcionType[] arrayErrores, [XmlElement(Form=XmlSchemaForm.Unqualified)] ref CodigoDescripcionType evento)
        {
