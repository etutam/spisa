namespace WSAFIPFE.xAFIPTest
{
    ...
    [GeneratedCode("System.Web.Services", "2.0.50727.3053"), WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.fex/"), DesignerCategory("code"), DebuggerStepThrough]
    public class Service : SoapHttpClientProtocol
    {
        ...
        public Service()
        {
            this.Url = MySettings.Default.WSAFIPFE_xAFIPTest_Service;
