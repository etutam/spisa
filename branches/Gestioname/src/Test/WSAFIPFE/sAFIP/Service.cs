namespace WSAFIPFE.sAFIP
{
    ...
    [DebuggerStepThrough, WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.seg/"), DesignerCategory("code"), GeneratedCode("System.Web.Services", "2.0.50727.3053")]
