namespace WSAFIPFE.afipTest
{
    ...
    [WebServiceBinding(Name="ServiceSoap", Namespace="http://ar.gov.afip.dif.facturaelectronica/"), GeneratedCode("System.Web.Services", "2.0.50727.3053"), DesignerCategory("code"), DebuggerStepThrough]
    public class Service : SoapHttpClientProtocol
    {
        ...
        public Service()
        {
            this.Url = MySettings.Default.WSAFIPFE_afipTest_Service;
